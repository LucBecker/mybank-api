...
public class Transaction implements Serializable {
    ...
    public Boolean getItWithdraw() {
        return isItWithdraw;
    }

    public void setItWithdraw(Boolean itWithdraw) {
        isItWithdraw = itWithdraw;
    }

    public Boolean getItDeposit() {
        return isItDeposit;
    }

    public void setItDeposit(Boolean itDeposit) {
        isItDeposit = itDeposit;
    }
